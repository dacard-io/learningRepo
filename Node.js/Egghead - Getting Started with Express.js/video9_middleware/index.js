...
/* In this tutorial, I will cover middleware. Although thats a fancy new buzzword to learn,
   you have actually been using it the whole time. app.get, express.static, bodyParser, etc. 
   So the notation is router.get, so its called router level middleware, and app.get is called
   application level middleware.*/

// Load up express first
var express = require('express');
var app = express(); /* In this tutorial, I will cover middleware. Although thats a fancy new buzzword to learn,
   you have actually been using it the whole time. app.get, express.static, bodyParser, etc. 
   So the notation is router.get, so its called router level middleware, and app.get is called
   application level middleware.*/
