...
/* In this tutorial, I will cover using MongoDB with Node/Express. As of now, you have been
   using the filesystem to store data, while this is okay and won't fit for making dynamic
   applications. We are going to load a file called user_list.json into our database (notice
   	that the json file we are loading isn't quite a proper json file, but its what MongoDB
   	uses, so follow their convention) */

// Load up express first
var express = require('express');
var app = express();
 // Create an instance of express, and call the object "app"
...
// Pull in User object from db.js
...
app.get('/', function(request, response) {
	...
	// Literally three lines of code replaced like 15 lines below. Wtf
